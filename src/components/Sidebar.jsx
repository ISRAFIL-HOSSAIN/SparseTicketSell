...
import { useStateContext,currentContext } from '../contexts/ContextProvider'; 
...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray-2';
      ...
      <>
        <div className='flex justify-between items-center'>
          ...
          className = "items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tighter dark:text-white text-slate-900">
            <SiAirbnb/><span>Ticket System</span>
          </Link>
